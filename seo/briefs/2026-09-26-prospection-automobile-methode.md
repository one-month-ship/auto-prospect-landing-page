...
- [FACT-CHECK HUMAIN] Auteur : l'article est signé « l'équipe Auto-Prospect » avec un `author` de type Organization, faute d'auteur validé (profil §12). À remplacer par une personne (Nassim ou un profil métier) dès qu'il est confirmé, puis créer la page auteur.
